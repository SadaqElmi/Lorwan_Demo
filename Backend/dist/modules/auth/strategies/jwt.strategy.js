...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    constructor(configService, authService) {
        const keycloakUrl = configService.get("KEYCLOAK_AUTH_SERVER_URL") ||
            "http://localhost:9090";
        const realm = configService.get("KEYCLOAK_REALM") || "lorawan";
        super({
    ...
    getKeycloakPublicKey(token, done, jwksClientInstance) {
        try {
