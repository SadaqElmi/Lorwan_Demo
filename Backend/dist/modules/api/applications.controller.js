...
let ApplicationsController = class ApplicationsController {
    ...
    async list(organizationId, limit, offset, search) {
        const l = limit ? parseInt(limit, 10) : undefined;
        const o = offset ? parseInt(offset, 10) : undefined;
        return this.chirp.listApplications(organizationId, l, o, search);
    }
    async create(body) {
        const res = await this.chirp.createApplication(body.name, body.organizationId, { description: body.description, ...body.meta });
        return { id: res.id };
    }
