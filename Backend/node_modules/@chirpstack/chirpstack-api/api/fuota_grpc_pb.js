...
function serialize_api_ListFuotaDeploymentJobsRequest(arg) {
  if (!(arg instanceof api_fuota_pb.ListFuotaDeploymentJobsRequest)) {
    throw new Error('Expected argument of type api.ListFuotaDeploymentJobsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_ListFuotaDeploymentJobsRequest(buffer_arg) {
  return api_fuota_pb.ListFuotaDeploymentJobsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_ListFuotaDeploymentJobsResponse(arg) {
  if (!(arg instanceof api_fuota_pb.ListFuotaDeploymentJobsResponse)) {
    throw new Error('Expected argument of type api.ListFuotaDeploymentJobsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_ListFuotaDeploymentJobsResponse(buffer_arg) {
  return api_fuota_pb.ListFuotaDeploymentJobsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
listJobs: {
    path: '/api.FuotaService/ListJobs',
    requestStream: false,
    responseStream: false,
    requestType: api_fuota_pb.ListFuotaDeploymentJobsRequest,
    responseType: api_fuota_pb.ListFuotaDeploymentJobsResponse,
    requestSerialize: serialize_api_ListFuotaDeploymentJobsRequest,
    requestDeserialize: deserialize_api_ListFuotaDeploymentJobsRequest,
    responseSerialize: serialize_api_ListFuotaDeploymentJobsResponse,
    responseDeserialize: deserialize_api_ListFuotaDeploymentJobsResponse,
  },
};

exports.FuotaServiceClient = grpc.makeGenericClientConstructor(FuotaServiceService, 'FuotaService');
