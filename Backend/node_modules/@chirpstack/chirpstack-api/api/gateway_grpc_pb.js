...
function serialize_api_DeleteRelayGatewayRequest(arg) {
  if (!(arg instanceof api_gateway_pb.DeleteRelayGatewayRequest)) {
    throw new Error('Expected argument of type api.DeleteRelayGatewayRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_DeleteRelayGatewayRequest(buffer_arg) {
  return api_gateway_pb.DeleteRelayGatewayRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_api_GetGatewayDutyCycleMetricsRequest(arg) {
  if (!(arg instanceof api_gateway_pb.GetGatewayDutyCycleMetricsRequest)) {
    throw new Error('Expected argument of type api.GetGatewayDutyCycleMetricsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_GetGatewayDutyCycleMetricsRequest(buffer_arg) {
  return api_gateway_pb.GetGatewayDutyCycleMetricsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_GetGatewayDutyCycleMetricsResponse(arg) {
  if (!(arg instanceof api_gateway_pb.GetGatewayDutyCycleMetricsResponse)) {
    throw new Error('Expected argument of type api.GetGatewayDutyCycleMetricsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_GetGatewayDutyCycleMetricsResponse(buffer_arg) {
  return api_gateway_pb.GetGatewayDutyCycleMetricsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_api_GetRelayGatewayRequest(arg) {
  if (!(arg instanceof api_gateway_pb.GetRelayGatewayRequest)) {
    throw new Error('Expected argument of type api.GetRelayGatewayRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_GetRelayGatewayRequest(buffer_arg) {
  return api_gateway_pb.GetRelayGatewayRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_GetRelayGatewayResponse(arg) {
  if (!(arg instanceof api_gateway_pb.GetRelayGatewayResponse)) {
    throw new Error('Expected argument of type api.GetRelayGatewayResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_GetRelayGatewayResponse(buffer_arg) {
  return api_gateway_pb.GetRelayGatewayResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_api_ListRelayGatewaysRequest(arg) {
  if (!(arg instanceof api_gateway_pb.ListRelayGatewaysRequest)) {
    throw new Error('Expected argument of type api.ListRelayGatewaysRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_ListRelayGatewaysRequest(buffer_arg) {
  return api_gateway_pb.ListRelayGatewaysRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_ListRelayGatewaysResponse(arg) {
  if (!(arg instanceof api_gateway_pb.ListRelayGatewaysResponse)) {
    throw new Error('Expected argument of type api.ListRelayGatewaysResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_ListRelayGatewaysResponse(buffer_arg) {
  return api_gateway_pb.ListRelayGatewaysResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_api_UpdateRelayGatewayRequest(arg) {
  if (!(arg instanceof api_gateway_pb.UpdateRelayGatewayRequest)) {
    throw new Error('Expected argument of type api.UpdateRelayGatewayRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_UpdateRelayGatewayRequest(buffer_arg) {
  return api_gateway_pb.UpdateRelayGatewayRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
getDutyCycleMetrics: {
    path: '/api.GatewayService/GetDutyCycleMetrics',
    requestStream: false,
    responseStream: false,
    requestType: api_gateway_pb.GetGatewayDutyCycleMetricsRequest,
    responseType: api_gateway_pb.GetGatewayDutyCycleMetricsResponse,
    requestSerialize: serialize_api_GetGatewayDutyCycleMetricsRequest,
    requestDeserialize: deserialize_api_GetGatewayDutyCycleMetricsRequest,
    responseSerialize: serialize_api_GetGatewayDutyCycleMetricsResponse,
    responseDeserialize: deserialize_api_GetGatewayDutyCycleMetricsResponse,
  },
  // Get the given Relay Gateway.
getRelayGateway: {
    path: '/api.GatewayService/GetRelayGateway',
    requestStream: false,
    responseStream: false,
    requestType: api_gateway_pb.GetRelayGatewayRequest,
    responseType: api_gateway_pb.GetRelayGatewayResponse,
    requestSerialize: serialize_api_GetRelayGatewayRequest,
    requestDeserialize: deserialize_api_GetRelayGatewayRequest,
    responseSerialize: serialize_api_GetRelayGatewayResponse,
    responseDeserialize: deserialize_api_GetRelayGatewayResponse,
  },
  // List the detected Relay Gateways.
listRelayGateways: {
    path: '/api.GatewayService/ListRelayGateways',
    requestStream: false,
    responseStream: false,
    requestType: api_gateway_pb.ListRelayGatewaysRequest,
    responseType: api_gateway_pb.ListRelayGatewaysResponse,
    requestSerialize: serialize_api_ListRelayGatewaysRequest,
    requestDeserialize: deserialize_api_ListRelayGatewaysRequest,
    responseSerialize: serialize_api_ListRelayGatewaysResponse,
    responseDeserialize: deserialize_api_ListRelayGatewaysResponse,
  },
  // Update the given Relay Gateway.
updateRelayGateway: {
    path: '/api.GatewayService/UpdateRelayGateway',
    requestStream: false,
    responseStream: false,
    requestType: api_gateway_pb.UpdateRelayGatewayRequest,
    responseType: google_protobuf_empty_pb.Empty,
    requestSerialize: serialize_api_UpdateRelayGatewayRequest,
    requestDeserialize: deserialize_api_UpdateRelayGatewayRequest,
    responseSerialize: serialize_google_protobuf_Empty,
    responseDeserialize: deserialize_google_protobuf_Empty,
  },
  // Delete the given Relay Gateway.
deleteRelayGateway: {
    path: '/api.GatewayService/DeleteRelayGateway',
    requestStream: false,
    responseStream: false,
    requestType: api_gateway_pb.DeleteRelayGatewayRequest,
    responseType: google_protobuf_empty_pb.Empty,
    requestSerialize: serialize_api_DeleteRelayGatewayRequest,
    requestDeserialize: deserialize_api_DeleteRelayGatewayRequest,
    responseSerialize: serialize_google_protobuf_Empty,
    responseDeserialize: deserialize_google_protobuf_Empty,
  },
};
