...
export class ListGatewaysRequest extends jspb.Message {
  ...
  getOrderBy(): ListGatewaysRequest.OrderByMap[keyof ListGatewaysRequest.OrderByMap];
  setOrderBy(value: ListGatewaysRequest.OrderByMap[keyof ListGatewaysRequest.OrderByMap]): void;
...
export namespace ListGatewaysRequest {
  export type AsObject = {
    ...
    orderBy: ListGatewaysRequest.OrderByMap[keyof ListGatewaysRequest.OrderByMap],
    orderByDesc: boolean,
  }
