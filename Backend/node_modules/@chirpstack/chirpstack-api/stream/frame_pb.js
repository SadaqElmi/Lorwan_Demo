...
proto.stream.UplinkFrameLog.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    fType: jspb.Message.getFieldWithDefault(msg, 4, 0),
...
proto.stream.UplinkFrameLog.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = /** @type {!proto.common.FType} */ (reader.readEnum());
      msg.setFType(value);
      break;
    case 5:
...
/**
 * optional common.FType f_type = 4;
 * @return {!proto.common.FType}
 */
proto.stream.UplinkFrameLog.prototype.getFType = function() {
  return /** @type {!proto.common.FType} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};


/**
 * @param {!proto.common.FType} value
 * @return {!proto.stream.UplinkFrameLog} returns this
 */
proto.stream.UplinkFrameLog.prototype.setFType = function(value) {
...
proto.stream.DownlinkFrameLog.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    fType: jspb.Message.getFieldWithDefault(msg, 6, 0),
...
/**
 * optional common.FType f_type = 6;
 * @return {!proto.common.FType}
 */
proto.stream.DownlinkFrameLog.prototype.getFType = function() {
  return /** @type {!proto.common.FType} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};
 ...
 * @return {!proto.stream.DownlinkFrameLog} returns this
 */
proto.stream.DownlinkFrameLog.prototype.setFType = function(value) {
