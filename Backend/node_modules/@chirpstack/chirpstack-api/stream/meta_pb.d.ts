...
export class UplinkMeta extends jspb.Message {
  ...
  getFrameType(): common_common_pb.FTypeMap[keyof common_common_pb.FTypeMap];
  setFrameType(value: common_common_pb.FTypeMap[keyof common_common_pb.FTypeMap]): void;
...
export namespace UplinkMeta {
  export type AsObject = {
    ...
    frameType: common_common_pb.FTypeMap[keyof common_common_pb.FTypeMap],
  }
}
