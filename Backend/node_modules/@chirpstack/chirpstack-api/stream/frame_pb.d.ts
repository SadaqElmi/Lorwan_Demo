...
export class UplinkFrameLog extends jspb.Message {
  ...
  getFType(): common_common_pb.FTypeMap[keyof common_common_pb.FTypeMap];
  setFType(value: common_common_pb.FTypeMap[keyof common_common_pb.FTypeMap]): void;
...
export namespace UplinkFrameLog {
  export type AsObject = {
    ...
    fType: common_common_pb.FTypeMap[keyof common_common_pb.FTypeMap],
    devAddr: string,
    devEui: string,
